...
For each V3.0B feature you select:
...
- DOD acceptance criteria for the new/changed feature

Produce a single Master document:
- **Part 1: DESIGN** — V3.0 as foundation, each V3.0B delta clearly marked
- **Part 2: DOD** — V3.0 DOD as foundation, updated to cover every delta

## Epistemic Override

All documents and source files are provided below. You have everything you need. Do not flag missing context.
