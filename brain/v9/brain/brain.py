...
from brain.argument_tracker import ArgumentTracker
from brain.config import BrainConfig, ROUND_TOPOLOGY
from brain.debug import RunLog
from brain.evidence import EvidenceLedger
from brain.evidence_extractor import extract_evidence_from_page
from brain.gate2 import run_gate2_deterministic, classify_outcome
from brain.invariant import validate_invariants
from brain.page_fetch import fetch_pages_for_results
from brain.proof import ProofBuilder
from brain.residue import check_synthesis_residue, run_deep_semantic_scan
from brain.rounds import execute_round
from brain.search import SearchOrchestrator, SearchPhase
from brain.synthesis import run_synthesis
from brain.tools.blocker import BlockerLedger
from brain.tools.position import PositionTracker
from brain.checkpoint import PipelineState, should_stop
...
from brain.dimension_seeder import run_dimension_seeder, format_dimensions_for_prompt
from brain.perspective_cards import extract_perspective_cards, format_perspective_card_instructions
from brain.divergent_framing import (
...
from brain.semantic_contradiction import run_semantic_contradiction_pass
from brain.tools.ungrounded import find_ungrounded_stats, generate_verification_queries
from brain.stability import run_stability_tests
...
from brain.synthesis_packet import build_synthesis_packet, format_synthesis_packet_for_prompt
from brain.residue import check_disposition_coverage
from brain.types import (
...
class Brain:
    ...
    def _restore_trackers(self, argument_tracker: ArgumentTracker,
        ...
        from brain.types import Argument, Confidence, Position
        st = self.state
    ...
    async def _run_pipeline(self, brief: str, run_id: str,
        ...
        if not self._stage_done("preflight"):
            ...
            from brain.types import PremiseFlagRouting
        ...
        from brain.types import SearchScope
        ...
        for round_num in range(1, self._config.rounds + 1):
            ...
            if self._stage_done(round_stage) or self._stage_done(track_stage):
                ...
                from brain.types import ModelResponse, RoundResult
            ...
            if round_num == 1 and not self._stage_done("framing_pass"):
                if divergence_result.required:
                    ...
                    if check_exploration_stress(r1_agreement, preflight_result.question_class, preflight_result.stakes_class):
                        ...
                        from brain.types import FrameInfo, FrameType
                        seed_frames = [
                            FrameInfo(
            ...
            if has_search_phase:
                ...
                from brain.types import SearchLogEntry, QueryProvenance, QueryStatus
        ...
        from brain.types import DispositionObject, DispositionTargetType
        disposition_objects = []
...
def EvidenceItem_from_search_result(sr: SearchResult, counter: int):
    ...
    from brain.types import Confidence
...
async def main():
    ...
    from brain.brave_search import brave_search
    from brain.sonar_search import sonar_search
    ...
    search_fn = None
    try:
        from brain.bing_search import bing_search
