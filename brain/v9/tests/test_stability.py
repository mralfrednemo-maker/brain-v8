...
def test_conclusion_stable_all_agree():
    from brain.stability import compute_conclusion_stability
    positions = {
...
def test_reason_stable_with_supported_claims():
    from brain.stability import compute_reason_stability
    claims = [
...
def test_assumption_stable_no_issues():
    from brain.stability import compute_assumption_stability
    assumptions = [
...
def test_fast_consensus_detection():
    from brain.stability import detect_fast_consensus
    r1_pos = {
...
def test_groupthink_warning():
    from brain.stability import compute_groupthink_warning
