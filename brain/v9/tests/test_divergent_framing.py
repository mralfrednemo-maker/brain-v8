...
async def test_framing_extract_produces_frames():
    from brain.divergent_framing import run_framing_extract
...
async def test_frame_survival_r2_needs_3_votes():
    from brain.divergent_framing import run_frame_survival_check
...
def test_exploration_stress_triggers():
    from brain.divergent_framing import check_exploration_stress
...
def test_format_frames_for_prompt():
    from brain.divergent_framing import format_frames_for_prompt
    frames = [
...
def test_format_r2_enforcement():
    from brain.divergent_framing import format_r2_frame_enforcement
...
def test_validate_r2_frame_obligations_complete():
    from brain.divergent_framing import validate_r2_frame_obligations
